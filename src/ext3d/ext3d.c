...
void quad_normal(flat3dinfo_t *flat3dinfo, int x, int z, double *nx, double *ny, double *nz)
{
	...
	*/
	...
	Ax = flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount] - flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount];
	Ay = flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount] - flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount];
	Az = flat3dinfo->zt[(x+0)+(z+0)*flat3dinfo->ucount] - flat3dinfo->zt[(x+0)+(z+1)*flat3dinfo->ucount];
	Bx = flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount] - flat3dinfo->xt[(x+1)+(z+0)*flat3dinfo->ucount];
	By = flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount] - flat3dinfo->yt[(x+1)+(z+0)*flat3dinfo->ucount];
	Bz = flat3dinfo->zt[(x+0)+(z+0)*flat3dinfo->ucount] - flat3dinfo->zt[(x+1)+(z+0)*flat3dinfo->ucount];
	nx1 = Ay*Bz - Az*By;
	ny1 = Az*Bx - Ax*Bz;
	nz1 = Ax*By - Ay*Bx;

	Ax = flat3dinfo->xt[(x+1)+(z+0)*flat3dinfo->ucount] - flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount];
	Ay = flat3dinfo->yt[(x+1)+(z+0)*flat3dinfo->ucount] - flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount];
	Az = flat3dinfo->zt[(x+1)+(z+0)*flat3dinfo->ucount] - flat3dinfo->zt[(x+0)+(z+0)*flat3dinfo->ucount];
	Bx = flat3dinfo->xt[(x+1)+(z+0)*flat3dinfo->ucount] - flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount];
	By = flat3dinfo->yt[(x+1)+(z+0)*flat3dinfo->ucount] - flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount];
	Bz = flat3dinfo->zt[(x+1)+(z+0)*flat3dinfo->ucount] - flat3dinfo->zt[(x+1)+(z+1)*flat3dinfo->ucount];
	nx2 = Ay*Bz - Az*By;
	ny2 = Az*Bx - Ax*Bz;
	nz2 = Ax*By - Ay*Bx;

	Ax = flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount] - flat3dinfo->xt[(x+1)+(z+0)*flat3dinfo->ucount];
	Ay = flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount] - flat3dinfo->yt[(x+1)+(z+0)*flat3dinfo->ucount];
	Az = flat3dinfo->zt[(x+1)+(z+1)*flat3dinfo->ucount] - flat3dinfo->zt[(x+1)+(z+0)*flat3dinfo->ucount];
	Bx = flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount] - flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount];
	By = flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount] - flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount];
	Bz = flat3dinfo->zt[(x+1)+(z+1)*flat3dinfo->ucount] - flat3dinfo->zt[(x+0)+(z+1)*flat3dinfo->ucount];
	nx3 = Ay*Bz - Az*By;
	ny3 = Az*Bx - Ax*Bz;
	nz3 = Ax*By - Ay*Bx;

	Ax = flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount] - flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount];
	Ay = flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount] - flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount];
	Az = flat3dinfo->zt[(x+0)+(z+1)*flat3dinfo->ucount] - flat3dinfo->zt[(x+1)+(z+1)*flat3dinfo->ucount];
	Bx = flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount] - flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount];
	By = flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount] - flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount];
	Bz = flat3dinfo->zt[(x+0)+(z+1)*flat3dinfo->ucount] - flat3dinfo->zt[(x+0)+(z+0)*flat3dinfo->ucount];
	nx4 = Ay*Bz - Az*By;
	ny4 = Az*Bx - Ax*Bz;
	nz4 = Ax*By - Ay*Bx;
...
int line(flat3dinfo_t *flat3dinfo, int x1, int z1, int x2, int z2)
{
	...
	cinterface->move_to(cinterface, flat3dinfo->xt[x1+z1*flat3dinfo->ucount],
									flat3dinfo->yt[x1+z1*flat3dinfo->ucount]);
	cinterface->line_to(cinterface, flat3dinfo->xt[x2+z2*flat3dinfo->ucount],
									flat3dinfo->yt[x2+z2*flat3dinfo->ucount]);
	cinterface->stroke(cinterface);
	/*printf("%.2f %.2f %.2f %.2f\n",
		flat3dinfo->xt[x1+z1*flat3dinfo->ucount], 
		flat3dinfo->yt[x1+z1*flat3dinfo->ucount],
		flat3dinfo->xt[x2+z2*flat3dinfo->ucount],
		flat3dinfo->yt[x2+z2*flat3dinfo->ucount]);*/
	return 1;
}
...
int quad(flat3dinfo_t *flat3dinfo, int x, int z)
{
	...
	kaplot_cinterface_t *cinterface = flat3dinfo->cinterface;
	data2davg = 1.0;
	data2davg = (flat3dinfo->colors[(x+0)+(z+0)*flat3dinfo->ucount] + flat3dinfo->colors[(x+1)+(z+0)*flat3dinfo->ucount]
		 + flat3dinfo->colors[(x+0)+(z+1)*flat3dinfo->ucount] + flat3dinfo->colors[(x+1)+(z+1)*flat3dinfo->ucount]) / 4.0;


	if(flat3dinfo->colorfunction)
	{
		if(!pygetcolor(flat3dinfo->colorfunction, data2davg, &r, &g, &b))
		{
			return 0;
		}
	}
	...
	if(flat3dinfo->shading)
	{
		...
		{
			r = r*(0.5+0.5*fabs(shade));
			g = g*(0.5+0.5*fabs(shade));
			b = b*(0.5+0.5*fabs(shade));
		}
	}
	...
	//if(shade < 0)
	{
		...
		//printf("x/z: %i %i\n", x, z);
		//printf("-> %f %f\n", flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount]);
		//printf("-> %f %f\n", flat3dinfo->xt[(x+1)+(z+0)*flat3dinfo->ucount], flat3dinfo->yt[(x+1)+(z+0)*flat3dinfo->ucount]);
		//printf("-> %f %f\n", flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount], flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount]);
		//printf("-> %f %f\n", flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount]);
		cinterface->move_to(cinterface, flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount]);
		cinterface->line_to(cinterface, flat3dinfo->xt[(x+1)+(z+0)*flat3dinfo->ucount], flat3dinfo->yt[(x+1)+(z+0)*flat3dinfo->ucount]);
		cinterface->line_to(cinterface, flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount], flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount]);
		cinterface->line_to(cinterface, flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount]);
		//printf("fill\n");
		...
		*/
		...
		cinterface->line_to(cinterface, flat3dinfo->xt[(x+1)+(z+1)*flat3dinfo->ucount], flat3dinfo->yt[(x+1)+(z+1)*flat3dinfo->ucount]);
		cinterface->line_to(cinterface, flat3dinfo->xt[(x+0)+(z+1)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+1)*flat3dinfo->ucount]);
		cinterface->line_to(cinterface, flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount]);
		cinterface->stroke(cinterface);
		/**/
	}
	//printf("-> %i,%i: %f %f\n", x,z, flat3dinfo->xt[(x+0)+(z+0)*flat3dinfo->ucount], flat3dinfo->yt[(x+0)+(z+0)*flat3dinfo->ucount]);
	return 1;
}
...
int flat3d(double* data2d, double matrix[4][4], flat3dinfo_t *flat3dinfo)
{
	...
	//indices = (int*)malloc(sizeof(int) * (flat3dinfo->ucount-1) * (flat3dinfo->height-1)); // quad indices, so we can sort them
	//zavg = (double*)malloc(sizeof(double) * (flat3dinfo->ucount-1) * (flat3dinfo->height-1)); // avg z of a quad
	zavg_and_index = (zavg_and_index_t*)malloc(sizeof(zavg_and_index_t) *
		 (flat3dinfo->ucount-1) * (flat3dinfo->height-1));

	for(z = 0; z < flat3dinfo->height; z++)
	{
		for(x = 0; x < flat3dinfo->ucount; x++)
		{
			w =						matrix[3][0] * x +
									matrix[3][1] * data2d[x + z*flat3dinfo->ucount] +
									matrix[3][2] * z +
									matrix[3][3];
			flat3dinfo->xt[x+z*flat3dinfo->ucount] =(	matrix[0][0] * x +
									matrix[0][1] * data2d[x + z*flat3dinfo->ucount] +
									matrix[0][2] * z +
									matrix[0][3]) / w;
			flat3dinfo->yt[x+z*flat3dinfo->ucount] =(	matrix[1][0] * x +
									matrix[1][1] * data2d[x + z*flat3dinfo->ucount] +
									matrix[1][2] * z +
									matrix[1][3]) / w;
			flat3dinfo->zt[x+z*flat3dinfo->ucount] =(	matrix[2][0] * x +
									matrix[2][1] * data2d[x + z*flat3dinfo->ucount] +
									matrix[2][2] * z +
									matrix[2][3]) / w;
		}
	}
	...
	for(z = 0; z < flat3dinfo->height; z++)
	{
		for(x = 0; x < flat3dinfo->ucount; x++)
		{
			if(flat3dinfo->data2dmin < data2d[x+z*flat3dinfo->ucount])
				flat3dinfo->data2dmin = data2d[x+z*flat3dinfo->ucount];
			if(flat3dinfo->data2dmax > data2d[x+z*flat3dinfo->ucount])
				flat3dinfo->data2dmax = data2d[x+z*flat3dinfo->ucount];
		}
	}
	...
	if(flat3dinfo->solid) /* draw solid, with possible wireframe, don't care about HLR */
	{
		...
		{
			for(x = 0; x < flat3dinfo->ucount-1; x++)
			{
				zavg_and_index[x+z*(flat3dinfo->ucount-1)].index = x+z*(flat3dinfo->ucount-1);
				zavg_and_index[x+z*(flat3dinfo->ucount-1)].zavg = (
							flat3dinfo->zt[x+z*flat3dinfo->ucount] +
							flat3dinfo->zt[x+1+z*flat3dinfo->ucount] +
							flat3dinfo->zt[x+(z+1)*flat3dinfo->ucount] +
							flat3dinfo->zt[x+1+(z+1)*flat3dinfo->ucount]
						) / 4.0;
		...
		printf("quicksorting...\n");
		qsort(zavg_and_index, (flat3dinfo->ucount-1)*(flat3dinfo->height-1),
			sizeof(zavg_and_index_t), cmpzavg);
		/*for(i = 0; i < (flat3dinfo->ucount-1)*(flat3dinfo->height-1)-1; i++)
		{
			for(j = (i+1); j < (flat3dinfo->ucount-1)*(flat3dinfo->height-1); j++)
			{
				if(zavg[i] < zavg[j])
				{
					ztemp = zavg[j];
		...
		for(i = 0; i < (flat3dinfo->ucount-1)*(flat3dinfo->height-1); i++)
		{
			//printf("%i,%i,%i ", indices[i], indices[i] % (flat3dinfo->ucount-1), indices[i] / (flat3dinfo->ucount-1));
			if(!quad(flat3dinfo, zavg_and_index[i].index % (flat3dinfo->ucount-1), zavg_and_index[i].index / (flat3dinfo->ucount-1)))
			{
				result = 0;
				break;
			}
	...
	else if(flat3dinfo->wireframe) /* only draw wireframe, TODO: HLR */
	{
		...
		for(z = 0; z < flat3dinfo->height-1; z++)
		{
			...
			line(flat3dinfo, (flat3dinfo->ucount-1),(z+0), (flat3dinfo->ucount-1),(z+1));
		}
		for(x = 0; x < flat3dinfo->ucount-1; x++)
		{
...
int mesh3d(double matrix[4][4], flat3dinfo_t *flat3dinfo)
{
	int u, v, i;
	double w;
	//int indextemp;
	...
	//zavg = (double*)malloc(sizeof(double) * (flat3dinfo->ucount-1) * (flat3dinfo->height-1)); // avg z of a quad
	zavg_and_index = (zavg_and_index_t*)malloc(sizeof(zavg_and_index_t) *
		 (flat3dinfo->ucount-1) * (flat3dinfo->vcount-1));

	for(u = 0; u < flat3dinfo->ucount; u++)
	{
		for(v = 0; v < flat3dinfo->vcount; v++)
		{
			w =						matrix[3][0] * flat3dinfo->x[u+v*flat3dinfo->ucount] +
									matrix[3][1] * flat3dinfo->y[u+v*flat3dinfo->ucount] +
									matrix[3][2] * flat3dinfo->z[u+v*flat3dinfo->ucount] +
									matrix[3][3];
			flat3dinfo->xt[u+v*flat3dinfo->ucount] =(
									matrix[0][0] * flat3dinfo->x[u+v*flat3dinfo->ucount] +
									matrix[0][1] * flat3dinfo->y[u+v*flat3dinfo->ucount] +
									matrix[0][2] * flat3dinfo->z[u+v*flat3dinfo->ucount] +
									matrix[0][3]) / w;
			flat3dinfo->yt[u+v*flat3dinfo->ucount] =(
									matrix[1][0] * flat3dinfo->x[u+v*flat3dinfo->ucount] +
									matrix[1][1] * flat3dinfo->y[u+v*flat3dinfo->ucount] +
									matrix[1][2] * flat3dinfo->z[u+v*flat3dinfo->ucount] +
									matrix[1][3]) / w;
			flat3dinfo->zt[u+v*flat3dinfo->ucount] =(
									matrix[2][0] * flat3dinfo->x[u+v*flat3dinfo->ucount] +
									matrix[2][1] * flat3dinfo->y[u+v*flat3dinfo->ucount] +
									matrix[2][2] * flat3dinfo->z[u+v*flat3dinfo->ucount] +
									matrix[2][3]);
		}
	}
	/*flat3dinfo->data2dmin = data2d[0];
	...
	//printf("lengths: %d %d\n", flat3dinfo->ucount, flat3dinfo->vcount);

	if(flat3dinfo->solid) /* draw solid, with possible wireframe, don't care about HLR */
	{
		for(u = 0; u < flat3dinfo->ucount-1; u++)
		{
			for(v = 0; v < flat3dinfo->vcount-1; v++)
			{
				zavg_and_index[u+v*(flat3dinfo->ucount-1)].index = u+v*(flat3dinfo->ucount-1);
				zavg_and_index[u+v*(flat3dinfo->ucount-1)].zavg = (
							flat3dinfo->zt[u+v*flat3dinfo->ucount] +
							flat3dinfo->zt[u+1+v*flat3dinfo->ucount] +
							flat3dinfo->zt[u+(v+1)*flat3dinfo->ucount] +
							flat3dinfo->zt[u+1+(v+1)*flat3dinfo->ucount]
						) / 4.0;
		...
		// quicksort from front to back;
		printf("quicksorting...\n");
		qsort(zavg_and_index, (flat3dinfo->vcount-1)*(flat3dinfo->ucount-1),
			sizeof(zavg_and_index_t), cmpzavg);
		/*for(i = 0; i < (flat3dinfo->ucount-1)*(flat3dinfo->height-1)-1; i++)
		{
			for(j = (i+1); j < (flat3dinfo->ucount-1)*(flat3dinfo->height-1); j++)
		...
		for(i = 0; i < (flat3dinfo->ucount-1)*(flat3dinfo->vcount-1); i++)
		{
			//printf("%d ", i);
			//printf("%i,%i,%i ", indices[i], indices[i] % (flat3dinfo->ucount-1), indices[i] / (flat3dinfo->ucount-1));
			if(!quad(flat3dinfo, zavg_and_index[i].index % (flat3dinfo->ucount-1), zavg_and_index[i].index / (flat3dinfo->ucount-1)))
	...
	else if(flat3dinfo->wireframe) /* only draw wireframe, TODO: HLR */
	{
		...
		for(u = 0; u < flat3dinfo->ucount-1; u++)
		{
			for(v = 0; v < flat3dinfo->vcount-1; v++)
			{
					if(!line(flat3dinfo, (u+0),(v+0), (u+1),(v+0)) ||
						!line(flat3dinfo, (u+0),(v+0), (u+0),(v+1)))
					{
						result = 0;
						break;
					}
			...
			line(flat3dinfo, (flat3dinfo->ucount-1),(v+0), (flat3dinfo->ucount-1),(v+1));
		}
		for(u = 0; u < flat3dinfo->ucount-1; u++)
		{
				if(!line(flat3dinfo, (u+0), (flat3dinfo->vcount-1), (u+1), (flat3dinfo->vcount-1)))
				{
					result = 0;
					break;
				}
...
PyObject* PyMesh3d(PyObject* self, PyObject *args, PyObject *kwargs)
{
	static char *kwlist[] = {"x", "y", "z", "matrix", "cinterface", "colors", "colorfunction",
			"shading", "shadefunction", "wireframe", "wirecolor",
			"solid", NULL};
	PyObject *result = NULL;
	PyObject *x, *y, *z;
	PyObject *colors;
	PyArrayObject *xArray, *yArray, *zArray, *colorArray;
	PyArrayObject *matrixArray;
	PyObject *pymatrix;
	PyObject *cinterface_object = NULL;
	kaplot_cinterface_t *cinterface;
	...
	if(PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOO!OO|O!OOOO:mesh3d", kwlist, &x, &y, &z, &pymatrix,
			&PyCObject_Type, &cinterface_object, &colors,
			&colorfunction, &PyBool_Type, &shading, &shadefunction,
			&wireframe, &wirecolor, &solid))
	{
		xArray = NA_InputArray(x, tFloat64, C_ARRAY);
		if(xArray == NULL)
			return PyErr_Format(PyExc_TypeError, "can't convert x into numpy array");
		if(xArray->nd != 2)
			return PyErr_Format(PyExc_TypeError, "x isn't 2 dimensional");
		flat3dinfo.ucount = xArray->dimensions[1];
		flat3dinfo.vcount = xArray->dimensions[0];

		yArray = NA_InputArray(y, tFloat64, C_ARRAY);
		if(yArray == NULL)
			return PyErr_Format(PyExc_TypeError, "can't convert y into numpy array");
		if(yArray->nd != 2)
			return PyErr_Format(PyExc_TypeError, "y isn't 2 dimensional");
		if((flat3dinfo.ucount != yArray->dimensions[1]) && 
			(flat3dinfo.vcount != yArray->dimensions[0]))
			return PyErr_Format(PyExc_TypeError, "y array should have the same dimensions as x");

		zArray = NA_InputArray(z, tFloat64, C_ARRAY);
		if(zArray == NULL)
			return PyErr_Format(PyExc_TypeError, "can't convert z into numpy array");
		if(zArray->nd != 2)
			return PyErr_Format(PyExc_TypeError, "z isn't 2 dimensional");
		if((flat3dinfo.ucount != zArray->dimensions[1]) && 
			(flat3dinfo.vcount != zArray->dimensions[0]))
			return PyErr_Format(PyExc_TypeError, "z array should have the same dimensions as x");

		colorArray = NA_InputArray(colors, tFloat64, C_ARRAY);
		if(colorArray == NULL)
			return PyErr_Format(PyExc_TypeError, "can't convert colors into numpy array");
		if(colorArray->nd != 2)
			return PyErr_Format(PyExc_TypeError, "colors isn't 2 dimensional");
		if((flat3dinfo.ucount != colorArray->dimensions[1]) && 
			(flat3dinfo.vcount != colorArray->dimensions[0]))
			return PyErr_Format(PyExc_TypeError, "colors array should have the same dimensions as x");
		...
		flat3dinfo.shadefunction = shadefunction;
		flat3dinfo.colorfunction = colorfunction;
		flat3dinfo.x = (double*)NA_OFFSETDATA(xArray);
		flat3dinfo.y = (double*)NA_OFFSETDATA(yArray);
		flat3dinfo.z = (double*)NA_OFFSETDATA(zArray);
		flat3dinfo.colors = (double*)NA_OFFSETDATA(colorArray);;
		flat3dinfo.solid = (solid == Py_True);
		flat3dinfo.shading = (shading == Py_True);
		flat3dinfo.wireframe = (wireframe == Py_True);
		flat3dinfo.wirecolor_r = wirecolor_r;
		...
		flat3dinfo.xt = (double*)malloc(sizeof(double) * flat3dinfo.ucount * flat3dinfo.vcount);
		flat3dinfo.yt = (double*)malloc(sizeof(double) * flat3dinfo.ucount * flat3dinfo.vcount);
		flat3dinfo.zt = (double*)malloc(sizeof(double) * flat3dinfo.ucount * flat3dinfo.vcount);

		mesh3d(matrix, &flat3dinfo);
...
static PyMethodDef pyext3d_functions[] = {
	...
	{"mesh3d", (PyCFunction)PyMesh3d, METH_VARARGS|METH_KEYWORDS, "draws a flat shaded surface"},
    { NULL, NULL, 0 }
};
...
init_ext3d(void)
{
	...
	if (c_api_object != NULL)
		PyModule_AddObject(mod, "_C_API", c_api_object);
			...
			/*
			if(	(xvalues[(x+0)+(z+1)*width] - xvalues[(x+0)+(z+0)*width]) *
				(yvalues[(x+1)+(z+0)*width]-yvalues[(x+0)+(z+0)*width]) >=
				(yvalues[(x+0)+(z+1)*width] - yvalues[(x+0)+(z+0)*width]) *
				(xvalues[(x+1)+(z+0)*width]-xvalues[(x+0)+(z+0)*width])
				)
			/**/
			/*{
				callback(userdata,	xvalues[(x+0)+(z+0)*width], yvalues[(x+0)+(z+0)*width],
									xvalues[(x+1)+(z+0)*width], yvalues[(x+1)+(z+0)*width],
									xvalues[(x+0)+(z+1)*width], yvalues[(x+0)+(z+1)*width]);
			}*/
			/*
			if(	(xvalues[(x+0)+(z+1)*width]-xvalues[(x+1)+(z+0)*width]) *
				(yvalues[(x+1)+(z+1)*width]-yvalues[(x+1)+(z+0)*width]) >=
			...
			/**/
			/*{
				callback(userdata,	xvalues[(x+1)+(z+0)*width], yvalues[(x+1)+(z+0)*width],
									xvalues[(x+1)+(z+1)*width], yvalues[(x+1)+(z+1)*width],
									xvalues[(x+0)+(z+1)*width], yvalues[(x+0)+(z+1)*width]);
			}*/
