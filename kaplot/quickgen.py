...
def fillrange(x, y1, y2, container=None, **kwargs):
	"""Draws a polygon between the y1 and y2 values"""
	if container is None:
		_checkContainer()
		container = current.container
	current.object = kaplot.objects.FillRange(container, x, y1, y2, **kwargs)
	return current.object

def grid(subgrid=False, xinterval=None, xinteger=False, xstart=None, xsubticks=3, xlogarithmic=False, yinterval=None, yinteger=False, ystart=None, ysubticks=3, ylogarithmic=False, container=None, **kwargs):
...
def histogramline(bins, data, binned=True, bincount=10, fill=False, drawverticals=False, drawsides=True, container=None, **kwargs):
...
def innercolorbar(label=None, image=None, levels=[], direction='up', location='right, top', labelposition=None, size=None, markers=[], markercolor="white", colormap='rainbow', datamin=None, datamax=None, edgespacing='10mm', container=None, **kwargs):
	"""HIDE"""
	if container is None:
		_checkContainer()
		container = current.container
	current.object = kaplot.objects.InnerColorbar(container, label=label, image=image, levels=levels, direction=direction, location=location, labelposition=labelposition, size=size, colormap=colormap, datamin=datamin, datamax=datamax, edgespacing=edgespacing, markers=markers, markercolor=markercolor, **kwargs)
	return current.object
...
def hline(y=0, container=None, **kwargs):
	if container is None:
		_checkContainer()
		container = current.container
	current.object = kaplot.objects.HLine(container, y=y, **kwargs)
	return current.object

def vline(x=0, container=None, **kwargs):
	if container is None:
		_checkContainer()
		container = current.container
	current.object = kaplot.objects.VLine(container, x=x, **kwargs)
	return current.object

def vfill(x1, x2, container=None, **kwargs):
	if container is None:
		_checkContainer()
		container = current.container
	current.object = kaplot.objects.VFill(container, x1=x1, x2=x2, **kwargs)
	return current.object
...
def symbols(x, y, symbolName='dot', xscales=None, yscales=None, angles=None, colors=None, colormap='rainbow', datamin=None, datamax=None, container=None, **kwargs):
...
# from decorators
def axes(viewport=((0, 0), (1, 1)), xinterval=None, xinteger=False, xstart=None, xsubticks=3, xlogarithmic=False, yinterval=None, yinteger=False, ystart=None, ysubticks=3, ylogarithmic=False, ticklength='3mm', labeloffset='1mm', linestyle='normal', linewidth='1px', container=None, **kwargs):
...
def axis(location='left', interval=None, integer=False, start=None, ticks=4, subticks=3, logarithmic=False, ticklength='3mm', labeloffset='1mm', linestyle='normal', linewidth='1px', intersects=None, halign=None, valign=None, intersection=None, spacing='3mm', container=None, **kwargs):
...
# from containers
def box(viewport=((0, 0), (1, 1)), world=None, title='', bottomlabel=None, leftlabel=None, rightlabel=None, toplabel=None, xinterval=None, xinteger=False, xstart=None, xsubticks=3, xlogarithmic=False, yinterval=None, yinteger=False, ystart=None, ysubticks=3, ylogarithmic=False, ticklength='3mm', labeloffset='1mm', page=None, **kwargs):
